          ...
          <div class="row">
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="service-3 col-md-4 col-sm-3 d-flex align-items-stretch" data-aos="fade-right">
                  <div class="card">
                    <div class="card-img">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="service-4 col-md-4 col-sm-3 d-flex align-items-stretch" data-aos="fade-left">
                  <div class="card">
                    <div class="card-img">
                ...
                <div class="service-5 col-md-4 col-sm-3 d-flex align-items-stretch" data-aos="fade-left">
                  <div class="card">
                    <div class="card-img">
                      <img src="assets/img/banner2.jpg" width="100%" alt="...">
                    </div>
                ...
                <div class="service-6 col-md-4 col-sm-3 d-flex align-items-stretch" data-aos="fade-left">
                  <div class="card">
                    <div class="card-img">
                      <img src="assets/img/banner2.jpg" width="100%" alt="...">
                    </div>
