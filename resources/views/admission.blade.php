        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <div class="d-block">
              ...
              <input type="date" name="date_of_birth" class="form-control" value="{{ old('date_of_birth') }}" id="date"
          ...
          <div class="form-group col-md-6">
            <div class="d-block">
              ...
              <input type="text" name="city" value="{{ old('city') }}" class="form-control" placeholder="Current City">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <div class="d-block">
              ...
              <input type="text" name="name_of_school" class="form-control" value="{{ old('name_of_school') }}"
